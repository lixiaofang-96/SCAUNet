...
from basicsr1.data.prefetch_dataloader import PrefetchDataLoader
from basicsr1.utils import get_root_logger, scandir
from basicsr1.utils.dist_util import get_dist_info
...
_dataset_modules = [
    importlib.import_module(f'basicsr1.data.{file_name}')
