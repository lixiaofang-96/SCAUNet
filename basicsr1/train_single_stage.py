            ...
            if opt.get('val') is not None and (current_iter %
                ...
                if metric_results is not None:
                    ...
                    for metric_name in opt['val']['metrics'].keys():
                        metric_value = metric_results.get(metric_name, None)
                ...
                # Single-stage restoration: use PSNR as the best-model criterion.
                if metric_results is not None and 'psnr' in metric_results:
